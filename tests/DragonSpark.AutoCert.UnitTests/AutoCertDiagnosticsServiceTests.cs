...
public class AutoCertDiagnosticsServiceTests
{
    private readonly Mock<IAccountStore> _accountStoreMock = new();
    private readonly Mock<IHttpClientFactory> _httpClientFactoryMock = new();
    private readonly Mock<ILogger<AutoCertDiagnosticsService>> _loggerMock = new();

    private readonly IOptions<AutoCertOptions> _options = Options.Create(new AutoCertOptions
    ...
    public async Task ValidateEnvironment_AllChecksPass_ReturnsTrue()
    {
        ...
        var service = new AutoCertDiagnosticsService(_options, _accountStoreMock.Object, _httpClientFactoryMock.Object,
            _loggerMock.Object);

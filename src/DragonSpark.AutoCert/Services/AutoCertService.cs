...
/// <summary>
///     Default implementation of <see cref="IAutoCertService" /> using the Certes library.
/// </summary>
public partial class AutoCertService(
    AutoCertServiceDependencies dependencies) : IAutoCertService
{
    ...
    private readonly ILogger<AutoCertService> _logger = dependencies.Logger;
    private readonly AutoCertOptions _options = dependencies.Options.Value;
    ...
    public async Task OrderCertificateAsync(IEnumerable<string> domains, CancellationToken cancellationToken = default)
    {
        ...
        using var activity = AutoCertDiagnostics.ActivitySource.StartActivity("AutoCertService.OrderCertificate");
        ...
        AutoCertDiagnostics.CertificatesRenewed.Add(1);
    }
        ...
        foreach (var authz in authzs)
        {
            ...
            foreach (var handler in _challengeHandlers)
            {
                ...
                try
                {
                    ...
                    sw.Stop();
                    AutoCertDiagnostics.ChallengeValidationDuration.Record(sw.Elapsed.TotalMilliseconds,
